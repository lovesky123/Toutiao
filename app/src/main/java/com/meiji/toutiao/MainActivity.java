...
import com.meiji.toutiao.module.media.channel.MediaChannelFragment;
import com.meiji.toutiao.module.news.NewsTabFragment;
import com.meiji.toutiao.module.photo.PhotoTabFragment;
import com.meiji.toutiao.module.search.SearchActivity;
import com.meiji.toutiao.module.video.VideoTabFragment;
...
public class MainActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private NewsTabFragment newsTabLayout;
    private PhotoTabFragment photoTabLayout;
    private VideoTabFragment videoTabLayout;
    private MediaChannelFragment mediaChannelView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            //TODO 新闻
            newsTabLayout = (NewsTabFragment) getSupportFragmentManager().findFragmentByTag(NewsTabFragment.class.getName());
            //TODO 图片
            photoTabLayout = (PhotoTabFragment) getSupportFragmentManager().findFragmentByTag(PhotoTabFragment.class.getName());
            //TODO 视频
            videoTabLayout = (VideoTabFragment) getSupportFragmentManager().findFragmentByTag(VideoTabFragment.class.getName());
            //TODO 头条号
            mediaChannelView = (MediaChannelFragment) getSupportFragmentManager().findFragmentByTag(MediaChannelFragment.class.getName());
            // 恢复 recreate 前的位置
        ...
        switch (index) {
            case FRAGMENT_NEWS:
                ...
                if (newsTabLayout == null) {
                    newsTabLayout = NewsTabFragment.getInstance();
                    ft.add(R.id.container, newsTabLayout, NewsTabFragment.class.getName());
                } else {
            ...
            case FRAGMENT_PHOTO:
                ...
                if (photoTabLayout == null) {
                    photoTabLayout = PhotoTabFragment.getInstance();
                    ft.add(R.id.container, photoTabLayout, PhotoTabFragment.class.getName());
                } else {
            ...
            case FRAGMENT_VIDEO:
                ...
                if (videoTabLayout == null) {
                    videoTabLayout = VideoTabFragment.getInstance();
                    ft.add(R.id.container, videoTabLayout, VideoTabFragment.class.getName());
                } else {
            ...
            case FRAGMENT_MEDIA:
                ...
                if (mediaChannelView == null) {
                    mediaChannelView = MediaChannelFragment.getInstance();
                    ft.add(R.id.container, mediaChannelView, MediaChannelFragment.class.getName());
                } else {
